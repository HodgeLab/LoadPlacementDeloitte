"""
main.py - Main script to run the power system analysis with new load testing
"""
...
def main():
    ...
    # Step 2: Run unit commitment for the base case
    print("\n2. Running unit commitment optimization...")
    start_time = time.time()
    uc_results = solve_unit_commitment(buses, branches, generators, base_mva)
    print(f"   Completed in {time.time() - start_time:.2f} seconds")
